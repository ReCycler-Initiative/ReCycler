...
## Demo
You can test the development version of ReCycler at: http://www.recyclerapp.fi. Please note that the development version may not be the same as the version published on GitHub. [Auth0](https://auth0.com/) is utilized as the identity and access management (IAM) solution.
