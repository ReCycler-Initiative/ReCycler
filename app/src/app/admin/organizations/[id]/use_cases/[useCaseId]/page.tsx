  ...
  return (
    <PageTemplate>
      <div className="pb-10">
        <div className="admin-home-hero rounded-3xl border border-slate-200 bg-[radial-gradient(circle_at_top_left,_rgba(226,232,240,0.9),_rgba(255,255,255,1)_42%)] p-6 shadow-sm md:p-10">
          <div className="max-w-4xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href={`${rootPath}/locations`}
                className="admin-home-secondary-cta inline-flex items-center rounded-full border border-slate-300 bg-white px-5 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
              >
        ...
        <div className="admin-home-section mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
          <div className="flex items-center justify-between gap-3">
            <div>
              <h2 className="text-lg font-semibold text-slate-900">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {actionCards.map((card) => (
              <Link
                key={card.href}
                href={card.href}
                className="admin-home-action-card group rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:border-slate-300 hover:bg-white"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="admin-home-action-icon flex h-10 w-10 items-center justify-center rounded-xl bg-white text-slate-700 shadow-sm ring-1 ring-slate-200">
