...
- Sähkö- ja elektroniikkaromu → SER-keräykseen

Sekajätteeseen kuuluvat jätteet poltetaan usein energiantuotannon yhteydessä. Tällöin syntyvä energia hyödynnetään esimerkiksi lämmöntuotannossa. Energiakäyttö on jätteille viimeinen vaihtoehto, kun kierrätys ei ole mahdollista.

Kierrätyspisteen löytäminen:

Jos sinulla on jätettä, joka ei sovi muihin kierrätyskategorioihin, voit tarkistaa lähimmän sekajätteen vastaanottopisteen ReCycler-palvelusta valitsemalla "Sekajäte". Muista myös varmistaa paikalliset ohjeet erityisjätteiden, kuten vaarallisten jätteiden, käsittelyyn.
